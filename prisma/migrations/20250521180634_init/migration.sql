-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DISPONIBLE', 'SOLD', 'BORROWED', 'RETURNED', 'DONATED');
...
-- CreateIndex
CREATE INDEX "Client_codeRef_idx" ON "Client"("codeRef");
...
-- CreateIndex
CREATE UNIQUE INDEX "Client_codeRef_userId_key" ON "Client"("codeRef", "userId");

-- CreateIndex
CREATE INDEX "Product_userId_idx" ON "Product"("userId");

-- CreateIndex
CREATE INDEX "Product_codeRef_idx" ON "Product"("codeRef");
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_codeRef_userId_key" ON "Product"("codeRef", "userId");
